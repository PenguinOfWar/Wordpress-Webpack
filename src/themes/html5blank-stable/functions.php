...
function load_css_js()
{
    ...
    wp_enqueue_style('main', get_template_directory_uri() . '/bundled/' . $manifest->{'main.css'}, false, '1.0', 'all');

    /**
     * This is the custom style.css that comes built into the template
     * We don't touch it, so go nuts
     */
    wp_enqueue_style('style', get_template_directory_uri() . '/style.css', false, '1.0', 'all');

    wp_register_script('vendor', $templateRoot . '/bundled/' . $manifest->{'vendor.js'}, false, '1.0', false);
    wp_register_script('app', $templateRoot . '/bundled/' . $manifest->{'app.js'}, false, '1.0', false);
...
add_action('wp_enqueue_scripts', 'load_css_js'); // Add Theme Stylesheet
